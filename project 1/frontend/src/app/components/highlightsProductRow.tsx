          ...
          {mockProducts.map((product) => {
            ...
            return (
              ...
              >
                <div
                  className={`
                    relative w-full h-80 rounded-none mb-0
                ...
                >
                  <Image
                    ...
                    fill
                    className={`absolute inset-0 w-full h-full object-contain rounded-none transition-all duration-500 ${showVariation ? "opacity-0 invisible" : "opacity-100 visible"}`}
                    draggable={false}
                  ...
                  <Image
                    ...
                    fill
                    className={`absolute inset-0 w-full h-full object-contain rounded-none transition-all duration-500 ${showVariation ? "opacity-100 visible" : "opacity-0 invisible"}`}
                    draggable={false}
                    sizes="(max-width: 400px) 100vw, 400px"
                  />
                  {hovered === product.id && (
