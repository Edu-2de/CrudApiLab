...
export default function NewShoesRow() {
  ...
  return (
    <section className="w-full flex flex-col items-center bg-[#fcfaf5] py-12 select-none">
      {/* Tabs */}
